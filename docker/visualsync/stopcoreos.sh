...
do_shell fleetctl -strict-host-key-checking=false stop console@${INSTANCE}.service
do_shell fleetctl -strict-host-key-checking=false stop console-discovery@${INSTANCE}.service
do_shell fleetctl -strict-host-key-checking=false stop empty-mongodb@${INSTANCE}.service
do_shell fleetctl -strict-host-key-checking=false unload console-discovery@${INSTANCE}.service

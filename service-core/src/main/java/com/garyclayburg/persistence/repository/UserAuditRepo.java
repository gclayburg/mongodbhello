...
public interface UserAuditRepo extends MongoRepository<UserAudit, String>, QueryDslPredicateExecutor<UserAudit> {
    List<UserAudit> findByUser(User user);
    List<UserAudit> findByUser_Id(String id);  //_ is a hint to spring data to use user.id
    List<UserAudit> findById(@Param("id") String id);
}
